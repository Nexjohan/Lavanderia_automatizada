...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto max-w-md py-8">
        ...
        <div class="flex items-center justify-between mb-4 text-justify">
            <h1 class="text-3xl font-bold text-gray-800">Ingresar Pedido</h1>
        </div>
        <form id="pedidoForm" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <div class="mb-4">
            ...
            <div class="flex items-center justify-between">
                <button type="submit"
                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Agregar pedido</button>
            </div>
        </form>
    </div>

    <script src="../../scripts/pedido/add-pedido.js"></script>
</body>
</html>
