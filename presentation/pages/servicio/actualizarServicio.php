...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto max-w-md py-8">
        ...
        <div class="flex items-center justify-between mb-4 text-justify">
            <h1 class="text-3xl font-bold text-gray-800">Actualizar Servicios</h1>
        </div>

        <form id="actualizarServicioForm" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    ...
    <script src="../../scripts/servicio/actualizar-servicio.js"></script>
</body>
